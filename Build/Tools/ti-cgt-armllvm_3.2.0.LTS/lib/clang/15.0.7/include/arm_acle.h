...
/* See Section 5.9 "Coprocessor intrinsics" in ACLE Specification (2021Q1) */
#if defined(__ARM_FEATURE_COPROC)
  #if (__ARM_FEATURE_COPROC & 1)
    #if !__has_builtin(__arm_cdp)
    #define __arm_cdp(a,b,c,d,e,f)   __builtin_arm_cdp(a,b,c,d,e,f)
    #endif
    #if !__has_builtin(__arm_ldc)
    #define __arm_ldc(a,b,c)         __builtin_arm_ldc(a,b,c)
    #endif
    #if !__has_builtin(__arm_ldcl)
    #define __arm_ldcl(a,b,c)        __builtin_arm_ldcl(a,b,c)
    #endif
    #if !__has_builtin(__arm_stc)
    #define __arm_stc(a,b,c)         __builtin_arm_stc(a,b,c)
    #endif
    #if !__has_builtin(__arm_stcl)
    #define __arm_stcl(a,b,c)        __builtin_arm_stcl(a,b,c)
    #endif
    #if !__has_builtin(__arm_mcr)
    #define __arm_mcr(a,b,c,d,e,f)   __builtin_arm_mcr(a,b,c,d,e,f)
    #endif
    #if !__has_builtin(__arm_mrc)
    #define __arm_mrc(a,b,c,d,e)     __builtin_arm_mrc(a,b,c,d,e)
    #endif
  #endif

  #if (__ARM_FEATURE_COPROC & 2)
    #if !__has_builtin(__arm_cdp2)
    #define __arm_cdp2(a,b,c,d,e,f)  __builtin_arm_cdp2(a,b,c,d,e,f)
    #endif
    #if !__has_builtin(__arm_ldc2)
    #define __arm_ldc2(a,b,c)        __builtin_arm_ldc2(a,b,c)
    #endif
    #if !__has_builtin(__arm_ldc2l)
    #define __arm_ldc2l(a,b,c)       __builtin_arm_ldc2l(a,b,c)
    #endif
    #if !__has_builtin(__arm_stc2)
    #define __arm_stc2(a,b,c)        __builtin_arm_stc2(a,b,c)
    #endif
    #if !__has_builtin(__arm_stc2l)
    #define __arm_stc2l(a,b,c)       __builtin_arm_stc2l(a,b,c)
    #endif
    #if !__has_builtin(__arm_mcr2)
    #define __arm_mcr2(a,b,c,d,e,f)  __builtin_arm_mcr2(a,b,c,d,e,f)
    #endif
    #if !__has_builtin(__arm_mrc2)
    #define __arm_mrc2(a,b,c,d,e)    __builtin_arm_mrc2(a,b,c,d,e)
    #endif
  #endif

  #if (__ARM_FEATURE_COPROC & 4)
    #if !__has_builtin(__arm_mcrr)
    #define __arm_mcrr(a,b,c,d)      __builtin_arm_mcrr(a,b,c,d)
    #endif
    #if !__has_builtin(__arm_mrrc)
    #define __arm_mrrc(a,b,c)        __builtin_arm_mrrc(a,b,c)
    #endif
  #endif

  #if (__ARM_FEATURE_COPROC & 8)
    #if !__has_builtin(__arm_mcrr2)
    #define __arm_mcrr2(a,b,c,d)     __builtin_arm_mcrr2(a,b,c,d)
    #endif
    #if !__has_builtin(__arm_mrrc2)
    #define __arm_mrrc2(a,b,c)       __builtin_arm_mrrc2(a,b,c)
    #endif
  #endif
#endif /* defined(__ARM_FEATURE_COPROC) */
