ifeq ($(SOC),$(filter $(SOC), am574x am572x am571x k2h k2k k2l k2e k2g c6678 c6657 dra72x dra75x dra78x omapl137 c6747 omapl138 j7200 j721e tpr12 awr294x))
...
SRCS_ASM_COMMON += _csl_intcIntrEnDisRes.asm  _csl_intcIsrDispatch.asm  _csl_intcNmiDummy.asm _csl_intcEntry.asm _csl_intcSetIvp.asm
endif
